package com.cdj.materialcalculatortheme.domain
...
class ExpressionEvaluatorTest {
    ...
    fun `Expression with parentheses properly evaluated`() {
        evaluator = ExpressionEvaluator(
            listOf(
                ...
                ExpressionPart.Number(5.5),
                ExpressionPart.Op(Operation.DIVIDE),
                ExpressionPart.Number(11.0),
            )
        )
        assertThat(evaluator.evaluate()).isEqualTo(5.5)
    }
    ...
    fun `Expression with nested parentheses properly evaluated`() {
        ...
        assertThat(evaluator.evaluate()).isEqualTo(3.25)
    }
}